package com.cristiangoncas.greenhousemonitor.framework.remote.client
...
interface Api {
    ...
    suspend fun nextHeartBeat(): CustomResult<RemoteHeartBeat>
...
class ApiImpl(
    ...
    override suspend fun nextHeartBeat(): CustomResult<RemoteHeartBeat> {
        ...
        if (response.status.value in 200..299) {
            ...
            val heartBeat = json.decodeFromString<RemoteHeartBeat>(body)
